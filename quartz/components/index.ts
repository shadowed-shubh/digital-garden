...
componentRegistry.register("LorenzBackground", LorenzBackground, "built-in")
...
export { Head, Spacer, DesktopOnly, MobileOnly, NotFound, Flex, ConditionalRender, LorenzBackground }
